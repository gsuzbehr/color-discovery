...
const welcomeOutput = "Welcome to Color Discovery!  Find your perfect color!  We know how daunting it can be to choose a color, so we created Color Discovery to help. You're just a few steps away from finding the perfect color for your next project.  Let's get started!  First, select your room.";
const welcomeReprompt = "Find your perfect color!  Let's get started!  First, select your room.";
const helpOutput = 'You can demonstrate the delegate directive by saying "find my color".';
const helpReprompt = 'Try saying "find my color".';
const tripIntro = [
